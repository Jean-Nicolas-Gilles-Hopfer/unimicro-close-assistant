...
- 14 Sept: offline_access granted on the portal client; REST refresh token stored and verified (no hourly login). Video: intro/outro cut, VO assembled, waiting for the AE render.
