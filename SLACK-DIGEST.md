...
Unimicro staff seen answering: Jon Terje Aksland, Anders Tornes, sveinung, UniLars-Erik, anders.urrang.
...
- **Calling your own external API from a plugin**: allowed on test.unimicro.no today because the CSP is
  ...
  require a proxy; no timeline. (Anders Tornes, 8 Sept)
...
- **File image preview from a plugin** (page images of inbox files) is not supported yet; team working on
  file streaming, "ETA tomorrow" said 9 Sept. (Jon Terje)
...
- Demo companies are thin, especially payroll. Import centre: `test.unimicro.no/#/import/page`; download the
  ...
  to all API endpoints. (Jon Terje, 7–8 Sept)

## Other
- IP question (Marcus Tierney, 5 Sept): asked whether Unimicro can claim ownership of proprietary
...
- IP: Jon Terje Aksland, 5 Sept: "Yes, you own your code."
- CLI 0.1.6 regression (Stig Are Salemonsen, 11 Sept): after upgrading, `unimicro plugin dev` said the plugin
  was not registered on the dev lane. Anders Tornes: "lane"/"move-lane" only matter for people who used the CLI
